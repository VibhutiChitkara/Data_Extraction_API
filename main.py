...
def details(url):
    ...
    df1['club_name'] = ""
    df1.loc[df1['Club_Id'] == '683','club_name'] = 'New England Free Jacks'
    df1.loc[df1['Club_Id'] == '686','club_name'] = 'Rugby United New York'
    df1.loc[df1['Club_Id'] == '684','club_name'] = 'New Orleans Gold'
    df1.loc[df1['Club_Id'] == '680','club_name'] = 'San Diego Legions'
    df1.loc[df1['Club_Id'] == '677','club_name'] = 'Austin Gilgronis'
    df1.loc[df1['Club_Id'] == '679','club_name'] = 'Houston Sabercats'
    df1.loc[df1['Club_Id'] == '685','club_name'] = 'Old Glory DC'
    df1.loc[df1['Club_Id'] == '728','club_name'] = 'LA Giltinis'
    df1.loc[df1['Club_Id'] == '687','club_name'] = 'Rugby ATL'
    df1.loc[df1['Club_Id'] == '682','club_name'] = 'Utah Warriors'
    df1.loc[df1['Club_Id'] == '681','club_name'] = 'Seattle Seawolves'
    df1.loc[df1['Club_Id'] == '688','club_name'] = 'Toronto Arrows'
